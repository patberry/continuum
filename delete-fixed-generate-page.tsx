...
export default function GeneratePage() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      setSuccessMessage('Prompt generated! (10 credits)');
  ...
  const handleRefinePrompt = async () => {
    ...
    try {
      ...
      setSuccessMessage('Prompt refined! (2 credits)');
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8 flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-400">Generate Prompts</p>
          </div>
        ...
        <div className="bg-gray-900 border border-gray-700 rounded p-6 mb-8 flex justify-between items-center">
          <div>
            ...
            <span className="text-gray-500 text-sm ml-2">+50 Test Credits</span>
          </div>
          <div>
        ...
        <div className="space-y-6">
          ...
          <div className="flex gap-4">
            <button
              ...
              className={`flex-1 py-4 rounded font-bold text-lg transition-colors ${
            ...
            >
              {isGenerating ? 'GENERATING...' : 'GENERATE PROMPT (10 credits)'}
            </button>

            <button
              onClick={handleRefinePrompt}
              disabled={!lastGeneratedPrompt || isRefining}
              className={`px-6 py-4 rounded font-bold transition-colors ${
              ...
              style={{ fontFamily: 'JetBrains Mono, monospace' }}
            >
              {isRefining ? 'REFINING...' : 'REFINE PROMPT (2 credits)'}
            </button>
          </div>
